...
// FUENTE ÚNICA DE VERDAD (SSOT): Metadatos, Epistemología y Modelo 3D
// ============================================================================
...
(function(root) {
  ...
  const ARTWORKS_100 = [
  {
    ...
    "badge": "001",
    "epoch": 1,
    "epochName": "Antigüedad & Geometría",
    "year": "~530 a.C.",
    "author": "Pitágoras de Samos",
    "title": "El Teorema de Pitágoras",
    "sub": "La Métrica Fundamental del Espacio Euclídeo",
    "cat": "GEOMETRÍA SAGRADA · ~530 a.C.",
    "eq": "a² + b² = c²\n‖x‖² = ⟨x, x⟩",
    "eqShort": "a² + b² = c²",
    "metric": "Métrica Euclídea: g_ij = δ_ij",
    ...
    "theta": 0,
    "phi": 0.15,
    "archetype": "pythagoras",
    "pal": 0,
    "modelKey": "pythagoras",
    "epistemology": {
      "category": "A",
      "tag": "FÍSICA ESPACIAL · GEOMETRÍA EN ℝ³",
      "desc": "Geometría euclidiana de áreas ortogonales en el espacio euclídeo."
    }
  },
  {
    "id": 1,
    ...
    "epochName": "Antigüedad & Geometría",
    "year": "~250 a.C.",
    "author": "Arquímedes de Siracusa",
    "title": "La Ley de la Palanca",
    "sub": "Equilibrio Estático y Momentos de Fuerza",
    "cat": "ESTÁTICA CLÁSICA · ~250 a.C.",
    "eq": "F₁ · d₁ = F₂ · d₂\n∑ τ = 0",
    "eqShort": "F₁ · d₁ = F₂ · d₂",
    "metric": "Residuo de Momento: ‖∑ τ‖ = 0.000",
    ...
    "archetype": "lever",
    "pal": 1,
    "modelKey": "lever_archimedes",
    "epistemology": {
      "category": "A",
      "tag": "MECÁNICA CLÁSICA · ESTÁTICA EN ℝ³",
      "desc": "Equilibrio de momentos de fuerza tangibles en silicio."
    }
  },
  {
    "id": 2,
    ...
    "year": "~250 a.C.",
    "author": "Arquímedes de Siracusa",
    "title": "El Principio de Flotación",
    "sub": "Hidrostática y Empuje Gravitatorio",
    "cat": "MECÁNICA DE FLUIDOS · ~250 a.C.",
    "eq": "E = ρ_f · g · V_desp\nF_net = E - P",
    "eqShort": "E = ρ · g · V",
    "metric": "Equilibrio Boyante: E - mg = 0",
    ...
    "epistemology": {
      "category": "A",
      "tag": "HIDROSTÁTICA · EMPUJE EN ℝ³",
      "desc": "Gradiente de presión y volumen desplazado en fluidos reales."
    }
  },
  {
    "id": 3,
    ...
    "title": "La Espiral Áurea de Fibonacci",
    "sub": "Filotaxis y Proporción Divina",
    "cat": "MATEMÁTICA MEDIEVAL · 1202",
    "eq": "F_{n} = F_{n-1} + F_{n-2}\nlim (F_{n+1}/F_n) = φ = (1+√5)/2 ≈ 1.618033",
    "eqShort": "F_n = F_{n-1} + F_{n-2}",
    "metric": "Convergencia Áurea: |φ_n - φ| < 1e-12",
    ...
    "epistemology": {
      "category": "B",
      "tag": "DINÁMICA DISCRETA · ESPACIO DE CRECIMIENTO",
      "desc": "Distribución angular áurea de filotaxis proyectada en coordenadas cilíndricas."
    }
  },
  {
    "id": 4,
    ...
    "title": "La Ley de Caída Libre",
    "sub": "Cinemática Uniformemente Acelerada",
    "cat": "FÍSICA EXPERIMENTAL · 1604",
    "eq": "s(t) = ½ g t²\nv² = 2 g s",
    "eqShort": "s = ½ g t²",
    "metric": "Aceleración Local: g = 9.80665 m/s²",
    ...
    "theta": 1.26,
    "phi": 0.19,
    "archetype": "gravity_drop",
    "pal": 0,
    "modelKey": "kepler",
    "epistemology": {
      "category": "A",
      "tag": "CINEMÁTICA · CAÍDA LIBRE EN ℝ³",
      "desc": "Trayectoria parabólica continua acelerada por el campo gravitatorio terrestre."
    }
  },
  {
    "id": 5,
    ...
    "sub": "La Elipse Planetaria Cósmica",
    "cat": "MECÁNICA CELESTE · 1609",
    "eq": "r(θ) = p / (1 + e · cos θ)\ne = √(1 - b²/a²)",
    "eqShort": "r = p / (1 + e cos θ)",
    "metric": "Excentricidad Orbital: 0 ≤ e < 1",
    ...
    "epistemology": {
      ...
      "desc": "Cónica gravitatoria kepleriana con foco en el centro de masas."
    }
  },
  {
    "id": 6,
    ...
    "sub": "Ley de las Áreas y Momento Angular",
    "cat": "MECÁNICA CELESTE · 1609",
    "eq": "dA/dt = ½ r² θ̇ = L / (2m) = cte",
    "eqShort": "dA/dt = cte",
    "metric": "Momento Angular: dL/dt = 0",
    ...
    "epistemology": {
      ...
      "desc": "Velocidad areolar constante por fuerza central neta."
    }
  },
  {
    "id": 7,
    ...
    "sub": "La Armonía de los Mundos",
    "cat": "MECÁNICA CELESTE · 1619",
    "eq": "T² / a³ = 4π² / (G(M + m)) = k",
    "eqShort": "T² = k · a³",
    "metric": "Constante Kepleriana: k_sol ≈ 2.97e-19 s²/m³",
    ...
    "epistemology": {
      ...
      "desc": "Resonancia orbital periódica T² ∝ a³."
    }
  },
  {
    "id": 8,
    ...
    "epochName": "Antigüedad & Geometría",
    "year": "1621",
    "author": "Willebrord Snell / René Descartes",
    "title": "La Ley de Refracción de Snell",
    "sub": "El Quiebre de la Luz en la Frontera",
    "cat": "ÓPTICA GEOMÉTRICA · 1621",
    "eq": "n₁ · sin θ₁ = n₂ · sin θ₂\nv₁ / v₂ = sin θ₁ / sin θ₂",
    "eqShort": "n₁ sin θ₁ = n₂ sin θ₂",
    "metric": "Índice de Refracción: n = c / v ≥ 1",
    ...
    "theta": 2.51,
    "phi": 0.18,
    "archetype": "snell_refract",
    "pal": 0,
    "modelKey": "snell",
    "epistemology": {
      "category": "A",
      "tag": "ÓPTICA ONDULATORIA · DIOPTER EN ℝ³",
      "desc": "Discontinuidad de velocidad de fase en la interfaz dieléctrica."
    }
  },
  {
    "id": 9,
    ...
    "title": "Geometría Analítica Cartesiana",
    "sub": "La Unificación de la Forma y el Número",
    "cat": "ÁLGEBRA & GEOMETRÍA · 1637",
    "eq": "y = m x + b\nx² + y² = r²\nf(x, y) = 0",
    "eqShort": "f(x, y) = 0",
    "metric": "Espacio Coordenado: ℝ × ℝ",
    ...
    "epistemology": {
      ...
      "desc": "Marco abstracto de referencia ortogonal que mapea el álgebra a la geometría."
    }
  },
  {
    "id": 10,
    ...
    "epochName": "Antigüedad & Geometría",
    "year": "1637",
    "author": "Pierre de Fermat / Andrew Wiles",
    "title": "El Último Teorema de Fermat",
    "sub": "La Imposibilidad Aritmética de las Potencias",
    "cat": "TEORÍA DE NÚMEROS · 1637 / 1994",
    "eq": "aⁿ + bⁿ = cⁿ (a,b,c > 0, n > 2) ⇒ ∅\nModularity Theorem (Wiles)",
    "eqShort": "aⁿ + bⁿ ≠ cⁿ  (n > 2)",
    "metric": "Frontera Aritmética: 0 Soluciones Enteras",
    ...
    "theta": 3.14,
    "phi": 0.16,
    "archetype": "fermat_last",
    "pal": 2,
    "modelKey": "elliptic_curve",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · CURVA MODULAR DE FREY",
      "desc": "Identidad aritmética pura xⁿ + yⁿ = zⁿ; visualizada mediante su representación geométrica elíptica modular."
    }
  },
  {
    "id": 11,
    ...
    "title": "Principio de Fermat de Tiempo Mínimo",
    "sub": "La Semilla del Cálculo de Variaciones",
    "cat": "ÓPTICA VARIACIONAL · 1662",
    "eq": "δ ∫_{A}^{B} n(s) ds = 0\nt = ∫ dt = mínimo",
    "eqShort": "δ ∫ n ds = 0",
    "metric": "Variación Primera: δS = 0",
    ...
    "epistemology": {
      ...
      "desc": "Camino óptico de tiempo estacionario δ∫n ds = 0."
    }
  },
  {
    "id": 12,
    ...
    "year": "1676",
    "author": "Robert Hooke",
    "title": "La Ley de Elasticidad de Hooke",
    "sub": "La Fuerza Restauradora Armónica",
    "cat": "ELASTICIDAD CLÁSICA · 1676",
    "eq": "F = -k · x\nU = ½ k x²\nσ = E · ε",
    "eqShort": "F = -k · x",
    "metric": "Linealidad Hookeana: R² > 0.9999",
    ...
    "theta": 3.77,
    "phi": 0.17,
    "archetype": "hooke_spring",
    "pal": 0,
    "modelKey": "hooke_spring",
    "epistemology": {
      "category": "A",
      "tag": "ELASTICIDAD LINEAL · RESORTE EN ℝ³",
      "desc": "Fuerza restauradora proporcional a la deformación axial F = -kx."
    }
  },
  {
    "id": 13,
    ...
    "sub": "La Persistencia Inquebrantable del Movimiento",
    "cat": "MECÁNICA NEWTONIANA · 1687",
    "eq": "∑ F = 0 ⟹ v = cte\ndp/dt = 0",
    "eqShort": "∑ F = 0 ⟹ v = cte",
    "metric": "Conservación de Momentum: Δp = 0",
    ...
    "theta": 4.08,
    "phi": 0.23,
    "archetype": "newton_inertia",
    "pal": 1,
    "modelKey": "newton_mechanics",
    "epistemology": {
      "category": "A",
      "tag": "MECÁNICA NEWTONIANA · INERCIA EN ℝ³",
      "desc": "Partícula libre con momento lineal conservado."
    }
  },
  {
    "id": 14,
    ...
    "sub": "El Motor Dinámico del Universo Mecánico",
    "cat": "MECÁNICA NEWTONIANA · 1687",
    "eq": "F = dp/dt = m · a\na = d²x / dt²",
    "eqShort": "F = m · a",
    "metric": "Fuerza Neta: F - ma = 0",
    ...
    "epistemology": {
      ...
      "desc": "Vector de aceleración colineal con la fuerza neta F = ma."
    }
  },
  {
    "id": 15,
    ...
    "sub": "La Simetría Fundamental de las Fuerzas",
    "cat": "MECÁNICA NEWTONIANA · 1687",
    "eq": "F₁₂ = -F₂₁\nF₁₂ + F₂₁ = 0",
    "eqShort": "F₁₂ = -F₂₁",
    "metric": "Simetría de Interacción: ‖F₁₂ + F₂₁‖ = 0",
    ...
    "epistemology": {
      ...
      "desc": "Par de fuerzas iguales y opuestas en contacto mecánico."
    }
  },
  {
    "id": 16,
    ...
    "sub": "La Atracción Invisible que Sujeta los Astros",
    "cat": "GRAVITACIÓN CLÁSICA · 1687",
    "eq": "F = G · (m₁ · m₂) / r²\nG ≈ 6.67430 × 10⁻¹¹ N·m²/kg²",
    "eqShort": "F = G (m₁ m₂) / r²",
    "metric": "Invariante Gravitatorio: G = cte",
    ...
    "theta": 5.03,
    "phi": 0.19,
    "archetype": "gravitation_universal",
    "pal": 0,
    "modelKey": "einstein_curvature",
    "epistemology": {
      "category": "A",
      "tag": "GRAVITACIÓN · LEY DE NEWTON EN ℝ³",
      "desc": "Campo de atracción mutua con decaimiento radial 1/r²."
    }
  },
  {
    "id": 17,
    ...
    "sub": "La Disipación Térmica Convectiva",
    "cat": "TERMODINÁMICA TEMPRANA · 1701",
    "eq": "dT/dt = -k · (T - T_env)\nT(t) = T_env + (T₀ - T_env) e^{-kt}",
    "eqShort": "dT/dt = -k(T - T_env)",
    "metric": "Decaimiento Exponencial: T(t) → T_env",
    ...
    "theta": 5.34,
    "phi": 0.27,
    "archetype": "thermal_cooling",
    "pal": 1,
    "modelKey": "thermal_cooling",
    "epistemology": {
      "category": "A",
      "tag": "TERMODINÁMICA · CONVECCIÓN EN ℝ³",
      "desc": "Gradiente térmico radial y líneas de flujo convectivo en el medio."
    }
  },
  {
    "id": 18,
    ...
    "title": "El Teorema Fundamental del Cálculo",
    "sub": "El Vínculo Inverso entre Derivada e Integral",
    "cat": "ANÁLISIS MATEMÁTICO · 1675",
    "eq": "d/dx [ ∫_{a}^{x} f(t) dt ] = f(x)\n∫_{a}^{b} f'(x) dx = f(b) - f(a)",
    "eqShort": "∫_{a}^{b} f'(x) dx = f(b) - f(a)",
    "metric": "Error de Cuadratura: ‖I_exact - I_num‖ → 0",
    ...
    "theta": 5.65,
    "phi": 0.16,
    "archetype": "calculus_fundamental",
    "pal": 2,
    "modelKey": "calculus_riemann",
    "epistemology": {
      "category": "B",
      "tag": "ANÁLISIS MATEMÁTICO · SUMA DE RIEMANN",
      "desc": "Variedad de integración geométrica bajo la curva f(x)dx."
    }
  },
  {
    "id": 19,
    ...
    "title": "Característica Polihédrica de Euler",
    "sub": "El Nacimiento de la Topología",
    "cat": "TOPOLOGÍA DISCRETA · 1752",
    "eq": "V - E + F = 2\nχ(M) = 2 - 2g",
    "eqShort": "V - E + F = 2",
    "metric": "Invariante Topológico: χ = 2",
    ...
    "theta": 5.97,
    "phi": 0.24,
    "archetype": "euler_polyhedra",
    "pal": 3,
    "modelKey": "euler",
    "epistemology": {
      "category": "A",
      "tag": "TOPOLOGÍA POLIÉDRICA · CARACTERÍSTICA DE EULER",
      "desc": "Invariante combinatorio V - E + F = 2 en poliedros convexos 3D."
    }
  },
  {
    "id": 20,
    "badge": "021",
    "epoch": 2,
    "epochName": "Ilustración & Ondas",
    "year": "1748",
    "author": "Leonhard Euler",
    "title": "La Identidad Sagrada de Euler",
    "sub": "La Ecuación Más Bella de la Matemática",
    "cat": "ANÁLISIS COMPLEJO · 1748",
    "eq": "e^{iπ} + 1 = 0\ne^{iθ} = cos θ + i sin θ",
    "eqShort": "e^{iπ} + 1 = 0",
    "metric": "Residuo Trascendental: |e^{iπ} + 1| = 0.000000",
    ...
    "theta": 0.16,
    "phi": 0.34,
    "archetype": "euler_identity",
    "pal": 0,
    "modelKey": "euler_identity",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · PLANO COMPLEJO DE ARGAND",
      "desc": "Identidad e^{iπ} + 1 = 0 en el plano complejo; fasores circulares unitarios."
    }
  },
  {
    "id": 21,
    ...
    "title": "La Ecuación de Bernoulli",
    "sub": "Conservación de Energía Hidrodinámica",
    "cat": "MECÁNICA DE FLUIDOS · 1738",
    "eq": "p + ½ ρ v² + ρ g h = cte\nΔp = -½ ρ Δ(v²)",
    "eqShort": "p + ½ ρ v² = cte",
    "metric": "Conservación de Presión Total: ΔP = 0",
    ...
    "theta": 0.47,
    "phi": 0.42,
    "archetype": "bernoulli_fluid",
    "pal": 1,
    "modelKey": "bernoulli_tube",
    "epistemology": {
      "category": "A",
      "tag": "FLUIDODINÁMICA · TUBO DE VENTURI EN ℝ³",
      "desc": "Conservación de energía a lo largo de una línea de corriente continua."
    }
  },
  {
    "id": 22,
    ...
    "title": "Ecuación de Onda Unidimensional",
    "sub": "La Propagación de las Ondas Clásicas",
    "cat": "FÍSICA ONDULATORIA · 1747",
    "eq": "∂²u/∂t² = c² · ∂²u/∂x²\nu(x,t) = f(x - ct) + g(x + ct)",
    "eqShort": "∂²u/∂t² = c² ∂²u/∂x²",
    "metric": "Velocidad de Fase: c = √(T / μ)",
    ...
    "theta": 0.79,
    "phi": 0.38,
    "archetype": "wave_dalembert",
    "pal": 2,
    "modelKey": "wave_string",
    "epistemology": {
      "category": "A",
      "tag": "MECÁNICA ONDULATORIA · CUERDA EN ℝ³",
      "desc": "Superposición armónica exacta de ondas viajeras y modos propios de Fourier."
    }
  },
  {
    "id": 23,
    ...
    "title": "Ecuaciones de Euler-Lagrange",
    "sub": "El Principio de Mínima Acción",
    "cat": "MECÁNICA ANALÍTICA · 1788",
    "eq": "d/dt (∂L/∂q̇_i) - ∂L/∂q_i = 0\nL = T - V\nδS = δ ∫ L dt = 0",
    "eqShort": "d/dt(∂L/∂q̇) - ∂L/∂q = 0",
    "metric": "Acción Estacionaria: δS = 0",
    ...
    "epistemology": {
      ...
      "desc": "Variedad variacional de acción mínima δS = 0 entre infinitas trayectorias."
    }
  },
  {
    "id": 24,
    ...
    "epochName": "Ilustración & Ondas",
    "year": "1750",
    "author": "Leonhard Euler / Daniel Bernoulli",
    "title": "Ecuación de Vigas de Euler-Bernoulli",
    "sub": "La Resistencia Estructural de la Materia",
    "cat": "INGENIERÍA ESTRUCTURAL · 1750",
    "eq": "EI · d⁴w/dx⁴ = q(x)\nM(x) = -EI · d²w/dx²",
    "eqShort": "EI · d⁴w/dx⁴ = q(x)",
    "metric": "Flexión Elástica: σ_max ≤ σ_adm",
    ...
    "theta": 1.41,
    "phi": 0.35,
    "archetype": "euler_beam",
    "pal": 0,
    "modelKey": "euler_beam",
    "epistemology": {
      "category": "A",
      "tag": "ELASTICIDAD ESTRUCTURAL · VIGA EN ℝ³",
      "desc": "Deflexión transversal por momento flector continuo E·I·w'''' = q."
    }
  },
  {
    "id": 25,
    ...
    "title": "Ley Electrostática de Coulomb",
    "sub": "La Atracción y Repulsión de las Cargas",
    "cat": "ELECTROSTÁTICA · 1785",
    "eq": "F = (1 / 4πε₀) · (q₁ q₂) / r²\nE = q / (4πε₀ r²)",
    "eqShort": "F = k_e (q₁ q₂) / r²",
    "metric": "Permitividad de Vacío: ε₀ ≈ 8.854e-12 F/m",
    ...
    "theta": 1.73,
    "phi": 0.44,
    "archetype": "coulomb_force",
    "pal": 1,
    "modelKey": "coulomb_field",
    "epistemology": {
      "category": "A",
      "tag": "ELECTROSTÁTICA · FUERZA DE COULOMB EN ℝ³",
      "desc": "Líneas de campo eléctrico radiales entre cargas electrostáticas puntuales."
    }
  },
  {
    "id": 26,
    ...
    "title": "Los Cantos de Chladni",
    "sub": "Morfología Nodal Cimática",
    "cat": "CIMÁTICA ACÚSTICA · 1787",
    "eq": "w(x,y) = sin(nπx)sin(mπy) - sin(mπx)sin(nπy) = 0\n∇²w + k²w = 0",
    "eqShort": "w(x,y) = 0  (Líneas Nodales)",
    "metric": "Residuo de Helmholtz: ‖(∇²+k²)w‖ ≤ 1e-5",
    ...
    "epistemology": {
      "category": "A",
      "tag": "CIMÁTICA ACÚSTICA · PLACA EN ℝ³",
      "desc": "Líneas nodales de reposo acústico por interferencia de ondas estacionarias 2D."
    }
  },
  {
    "id": 27,
    ...
    "sub": "La Termodinámica Clásica de la Presión",
    "cat": "TERMODINÁMICA · 1834",
    "eq": "P · V = n · R · T\nR ≈ 8.31446 J/(mol·K)",
    "eqShort": "P · V = n · R · T",
    "metric": "Constante Universal de los Gases: R",
    ...
    "epistemology": {
      "category": "B",
      "tag": "TERMODINÁMICA · VARIEDAD DE ESTADO P-V-T",
      "desc": "Superficie de ecuación de estado continua P(V, T) = nRT/V en el espacio termodinámico."
    }
  },
  {
    "id": 28,
    ...
    "title": "La Ecuación de Laplace",
    "sub": "El Potencial Armónico y la Suavidad Pura",
    "cat": "TEORÍA DEL POTENCIAL · 1789",
    "eq": "∇²ϕ = ∂²ϕ/∂x² + ∂²ϕ/∂y² + ∂²ϕ/∂z² = 0\nΔϕ = 0",
    "eqShort": "∇²ϕ = 0",
    "metric": "Propiedad del Valor Medio: ϕ(x₀) = ⟨ϕ⟩_S",
    ...
    "epistemology": {
      ...
      "desc": "Variedad minimal con curvatura media nula ∇²ϕ = 0."
    }
  },
  {
    "id": 29,
    ...
    "title": "La Ecuación de Poisson",
    "sub": "La Respuesta del Espacio a la Presencia de Materia",
    "cat": "FÍSICA MATEMÁTICA · 1813",
    "eq": "∇²ϕ = -ρ / ε₀\n∇²ϕ = 4π G ρ",
    "eqShort": "∇²ϕ = -ρ / ε₀",
    "metric": "Residuo de Fuente: ‖∇²ϕ + ρ/ε₀‖ ≤ 1e-6",
    ...
    "epistemology": {
      ...
      "desc": "Deformación del potencial escalar generada por fuentes densas."
    }
  },
  {
    "id": 30,
    ...
    "title": "La Serie y Transformada de Fourier",
    "sub": "La Descomposición Armónica de la Realidad",
    "cat": "ANÁLISIS ESPECTRAL · 1822",
    "eq": "f(t) = ∫_{-∞}^{∞} F(ω) e^{iωt} dω\nF(ω) = 1/(2π) ∫ f(t) e^{-iωt} dt",
    "eqShort": "F(ω) = ∫ f(t) e^{-iωt} dt",
    "metric": "Teorema de Parseval: ∫|f|² = 1/(2π)∫|F|²",
    ...
    "epistemology": {
      ...
      "desc": "Proyección del espectro armónico continuo en componentes ortogonales."
    }
  },
  {
    "id": 31,
    ...
    "year": "1822",
    "author": "Joseph Fourier",
    "title": "La Ecuación de Difusión del Calor",
    "sub": "La Homogeneización Entrópica Térmica",
    "cat": "TERMODINÁMICA CONTINUA · 1822",
    "eq": "∂u/∂t = α · ∇²u\nq = -k · ∇u",
    "eqShort": "∂u/∂t = α ∇²u",
    "metric": "Difusividad Térmica: α = k / (ρ c_p)",
    ...
    "epistemology": {
      ...
      "desc": "Propagación parabólica del calor ∂T/∂t = α∇²T en un sólido."
    }
  },
  {
    "id": 32,
    ...
    "year": "1824",
    "author": "Sadi Carnot",
    "title": "El Teorema de Carnot",
    "sub": "El Límite Máximo de la Eficiencia Térmica",
    "cat": "TERMODINÁMICA · 1824",
    "eq": "η_Carnot = 1 - (T_C / T_H)\nW_max = Q_H · (1 - T_C / T_H)",
    "eqShort": "η_max = 1 - T_C / T_H",
    "metric": "Eficiencia Reversible: η ≤ η_Carnot",
    ...
    "theta": 3.93,
    "phi": 0.37,
    "archetype": "carnot_cycle",
    "pal": 0,
    "modelKey": "carnot_cycle",
    "epistemology": {
      "category": "B",
      "tag": "TERMODINÁMICA · CICLO DE ESTADO (P, V, T)",
      "desc": "Trayectoria reversible cerrada compuesta por dos isotermas y dos adiabáticas."
    }
  },
  {
    "id": 33,
    ...
    "title": "La Ley de Conducción de Ohm",
    "sub": "La Resistencia Lineal al Paso de Electrones",
    "cat": "ELECTRODINÁMICA · 1827",
    "eq": "V = I · R\nJ = σ · E\nP = I² · R",
    "eqShort": "V = I · R",
    "metric": "Conductividad: σ = n q² τ / m",
    ...
    "epistemology": {
      ...
      "desc": "Flujo microscópico de densidad de corriente J = σE en silicio metálico."
    }
  },
  {
    "id": 34,
    ...
    "title": "Ley de Inducción de Faraday",
    "sub": "El Nacimiento de la Electricidad Dinámica",
    "cat": "ELECTROMAGNETISMO · 1831",
    "eq": "ℰ = -dΦ_B / dt\n∮ E · dl = -d/dt ∬ B · dA",
    "eqShort": "ℰ = -dΦ_B / dt",
    "metric": "Flujo Magnético: Φ_B = ∬ B · dA",
    ...
    "theta": 4.56,
    "phi": 0.34,
    "archetype": "faraday_induction",
    "pal": 2,
    "modelKey": "faraday_maxwell",
    "epistemology": {
      "category": "A",
      "tag": "INDUCCIÓN ELECTROMAGNÉTICA EN ℝ³",
      "desc": "Fuerza electromotriz generada por variación de flujo magnético en la espira."
    }
  },
  {
    "id": 35,
    ...
    "epochName": "Ilustración & Ondas",
    "year": "1834",
    "author": "John Scott Russell / Korteweg & de Vries",
    "title": "El Solitón Hidrodinámico de Russell (KdV)",
    "sub": "La Onda Solitaria que No Muere",
    "cat": "ONDAS NO LINEALES · 1834",
    "eq": "∂u/∂t + u · ∂u/∂x + δ² · ∂³u/∂x³ = 0\nu(x,t) = 2κ² · sech²(κ(x - 4κ² t))",
    "eqShort": "∂u/∂t + u ∂u/∂x + δ² ∂³u/∂x³ = 0",
    "metric": "Invariante de Masa KdV: I₁ = ∫ u dx = cte",
    ...
    "theta": 4.87,
    "phi": 0.46,
    "archetype": "kdv_soliton",
    "pal": 3,
    "modelKey": "kdv_soliton",
    "epistemology": {
      "category": "A",
      "tag": "HIDRODINÁMICA · SOLITÓN KDV EN ℝ³",
      "desc": "Onda solitaria no lineal que preserva su forma por balance dispersivo."
    }
  },
  {
    "id": 36,
    ...
    "title": "Mecánica Canónica de Hamilton",
    "sub": "El Espacio de Fases Simpléctico",
    "cat": "MECÁNICA CLÁSICA · 1833",
    "eq": "q̇ = ∂H/∂p\nṗ = -∂H/∂q\nH(q, p) = T(p) + V(q)",
    "eqShort": "q̇ = ∂H/∂p,  ṗ = -∂H/∂q",
    "metric": "Volumen de Fase (Liouville): dΩ/dt = 0",
    ...
    "theta": 5.18,
    "phi": 0.35,
    "archetype": "hamilton_phase",
    "pal": 0,
    "modelKey": "hamilton_phase",
    "epistemology": {
      "category": "B",
      "tag": "MECÁNICA HAMILTONIANA · TOROIDE SIMPLÉCTICO",
      "desc": "Toroide de Liouville-Arnol'd invariante bajo el flujo simpléctico canónico."
    }
  },
  {
    "id": 37,
    ...
    "year": "1843",
    "author": "William Rowan Hamilton",
    "title": "Álgebra de Cuaterniones de Hamilton",
    "sub": "La Rotación Pura en Cuatro Dimensiones",
    "cat": "ÁLGEBRA HIPERCOMPLEJA · 1843",
    "eq": "i² = j² = k² = i j k = -1\nq = w + x i + y j + z k",
    "eqShort": "i² = j² = k² = ijk = -1",
    "metric": "Norma Cuaterniónica: |q|² = w²+x²+y²+z²",
    ...
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · ÁLGEBRA DE HAMILTON",
      "desc": "Estructura hipercompleja de dimensión 4 sin análogo euclídeo tridimensional directo."
    }
  },
  {
    "id": 38,
    ...
    "sub": "El Desplazamiento Frecuencial del Movimiento",
    "cat": "ONDAS & RELATIVIDAD · 1842",
    "eq": "f = f₀ · (v ± v_r) / (v ∓ v_s)\nz = Δλ / λ₀ = v / c",
    "eqShort": "f = f₀ (v ± v_r) / (v ∓ v_s)",
    "metric": "Desplazamiento al Rojo: 1 + z = a_now / a_then",
    ...
    "epistemology": {
      "category": "A",
      "tag": "ACÚSTICA ONDULATORIA · EFECTO DOPPLER EN ℝ³",
      "desc": "Frentes de onda esféricos comprimidos por movimiento relativo subsónico."
    }
  },
  {
    "id": 39,
    ...
    "epochName": "Ilustración & Ondas",
    "year": "1845",
    "author": "Claude Navier & George Stokes",
    "title": "Vórtices de Navier-Stokes",
    "sub": "Turbulencia, Singularidad y Dinámica de Fluidos",
    "cat": "PROBLEMA DEL MILENIO · 1845",
    "eq": "ρ(∂u/∂t + (u·∇)u) = -∇p + μ∇²u + f\n∇·u = 0",
    "eqShort": "ρ(∂u/∂t + u·∇u) = -∇p + μ∇²u",
    "metric": "Enstrofía: Ω = ½ ∫ |ω|² dV < ∞",
    ...
    "theta": 6.13,
    "phi": 0.38,
    "archetype": "navier_stokes",
    "pal": 3,
    "modelKey": "navier_vortex",
    "epistemology": {
      "category": "A",
      "tag": "FLUIDODINÁMICA REAL · VÓRTICE DE BURGERS EN ℝ³",
      "desc": "Vórtice viscoso exacto de Navier-Stokes con balance entre estiramiento y difusión."
    }
  },
  {
    "id": 40,
    "badge": "041",
    "epoch": 3,
    "epochName": "Termodinámica & Luz",
    "year": "1865",
    "author": "James Clerk Maxwell",
    "title": "Primera Ecuación de Maxwell (Gauss Eléctrica)",
    "sub": "Las Fuentes Escalares del Campo Eléctrico",
    "cat": "ELECTROMAGNETISMO · 1865",
    "eq": "∇ · E = ρ / ε₀\n∯ E · dA = Q_enc / ε₀",
    "eqShort": "∇ · E = ρ / ε₀",
    "metric": "Conservación de Carga: ∇·J + ∂ρ/∂t = 0",
    ...
    "theta": 0,
    "phi": 0.54,
    "archetype": "maxwell_gauss_e",
    "pal": 0,
    "modelKey": "gauss_electric",
    "epistemology": {
      "category": "A",
      "tag": "ELECTROMAGNETISMO · LEY DE GAUSS ELÉCTRICA EN ℝ³",
      "desc": "Divergencia del campo eléctrico neta igual a la densidad de carga local."
    }
  },
  {
    "id": 41,
    ...
    "year": "1865",
    "author": "James Clerk Maxwell",
    "title": "Segunda Ecuación de Maxwell (Gauss Magnética)",
    "sub": "La Inexistencia de Monopolos Magnéticos",
    "cat": "ELECTROMAGNETISMO · 1865",
    "eq": "∇ · B = 0\n∯ B · dA = 0",
    "eqShort": "∇ · B = 0",
    "metric": "Ausencia de Monopolos: ∮ B·dA = 0",
    ...
    "theta": 0.31,
    "phi": 0.62,
    "archetype": "maxwell_gauss_b",
    "pal": 1,
    "modelKey": "gauss_magnetic",
    "epistemology": {
      "category": "A",
      "tag": "ELECTROMAGNETISMO · LEY DE GAUSS MAGNÉTICA EN ℝ³",
      "desc": "Ausencia estricta de monopolos magnéticos; líneas de campo cerradas."
    }
  },
  {
    "id": 42,
    ...
    "year": "1865",
    "author": "James Clerk Maxwell",
    "title": "Tercera Ecuación de Maxwell (Faraday-Maxwell)",
    "sub": "La Creación de Electricidad por Magnetismo Dinámico",
    "cat": "ELECTROMAGNETISMO · 1865",
    "eq": "∇ × E = -∂B/∂t\n∮ E · dl = -d/dt ∬ B · dA",
    "eqShort": "∇ × E = -∂B/∂t",
    "metric": "Inducción Rotacional: ∇×E + ∂B/∂t = 0",
    ...
    "epistemology": {
      ...
      "desc": "Rotacional eléctrico generado por flujo magnético temporal oscilante."
    }
  },
  {
    "id": 43,
    ...
    "year": "1865",
    "author": "James Clerk Maxwell",
    "title": "Cuarta Ecuación de Maxwell (Ampère-Maxwell)",
    "sub": "La Corriente de Desplazamiento que Cerró la Física",
    "cat": "ELECTROMAGNETISMO · 1865",
    "eq": "∇ × B = μ₀ J + μ₀ ε₀ ∂E/∂t\n∮ B · dl = μ₀ I + μ₀ ε₀ dΦ_E/dt",
    "eqShort": "∇ × B = μ₀ J + μ₀ ε₀ ∂E/∂t",
    "metric": "Corriente de Desplazamiento: J_D = ε₀ ∂E/∂t",
    ...
    "theta": 0.94,
    "phi": 0.68,
    "archetype": "maxwell_ampere",
    "pal": 3,
    "modelKey": "ampere_maxwell",
    "epistemology": {
      "category": "A",
      "tag": "ELECTROMAGNETISMO · LEY DE AMPÈRE-MAXWELL EN ℝ³",
      "desc": "Circulación magnética inducida por corriente de conducción y desplazamiento."
    }
  },
  {
    "id": 44,
    ...
    "year": "1865",
    "author": "James Clerk Maxwell",
    "title": "La Velocidad de la Luz en el Vacío",
    "sub": "La Constante Universal Cósmica",
    "cat": "ELECTRODINÁMICA · 1865",
    "eq": "c = 1 / √(ε₀ · μ₀) ≈ 299,792,458 m/s\n∇²E - (1/c²) ∂²E/∂t² = 0",
    "eqShort": "c = 1 / √(ε₀ μ₀)",
    "metric": "Velocidad de la Luz: c = 299792458 m/s (Exacto)",
    ...
    "theta": 1.26,
    "phi": 0.58,
    "archetype": "light_speed",
    "pal": 0,
    "modelKey": "minkowski",
    "epistemology": {
      "category": "A",
      "tag": "ELECTRODINÁMICA · ONDA LUMINOSA TRANSVERSAL EN ℝ³",
      "desc": "Campos E y B ortogonales propagándose en el vacío a velocidad c."
    }
  },
  {
    "id": 45,
    ...
    "title": "La Fuerza Electromagnética de Lorentz",
    "sub": "La Trayectoria Helicoidal de las Cargas",
    "cat": "ELECTRODINÁMICA CLÁSICA · 1895",
    "eq": "F = q · (E + v × B)\nr_c = m v_⊥ / (q B)",
    "eqShort": "F = q(E + v × B)",
    "metric": "Radio de Giro (Larmor): r_L = p_⊥ / (q B)",
    ...
    "theta": 1.57,
    "phi": 0.65,
    "archetype": "lorentz_force",
    "pal": 1,
    "modelKey": "lorentz_force",
    "epistemology": {
      "category": "A",
      "tag": "ELECTRODINÁMICA · FUERZA DE LORENTZ EN ℝ³",
      "desc": "Espiral helicoidal de ciclotrón bajo interacción vectorial F = q(E + v×B)."
    }
  },
  {
    "id": 46,
    ...
    "sub": "La Conservación Universal de la Energía",
    "cat": "TERMODINÁMICA · 1850",
    "eq": "dU = δQ - δW\n∮ dU = 0",
    "eqShort": "dU = δQ - δW",
    "metric": "Invariante Energético: ∮ dU = 0",
    ...
    "epistemology": {
      ...
      "desc": "Conservación de energía interna entre calor entrante y trabajo mecánico."
    }
  },
  {
    "id": 47,
    ...
    "year": "1865",
    "author": "Rudolf Clausius",
    "title": "Segunda Ley de la Termodinámica (Entropía)",
    "sub": "La Flecha Irreversible del Tiempo",
    "cat": "TERMODINÁMICA · 1865",
    "eq": "dS ≥ δQ / T\nΔS_universo ≥ 0",
    "eqShort": "ΔS ≥ 0",
    "metric": "Flecha del Tiempo: dS/dt ≥ 0",
    ...
    "theta": 2.2,
    "phi": 0.69,
    "archetype": "second_law_entropy",
    "pal": 3,
    "modelKey": "boltzmann_entropy",
    "epistemology": {
      "category": "B",
      "tag": "TERMODINÁMICA · FLECHA DEL TIEMPO",
      "desc": "Crecimiento irreversible de entropía en sistemas aislados dS ≥ 0."
    }
  },
  {
    "id": 48,
    ...
    "title": "La Entropía Estadística de Boltzmann",
    "sub": "El Puente Microscópico entre Desorden y Probabilidad",
    "cat": "MECÁNICA ESTADÍSTICA · 1877",
    "eq": "S = k_B · ln W\nk_B ≈ 1.380649 × 10⁻²³ J/K",
    "eqShort": "S = k_B · ln W",
    "metric": "Constante de Boltzmann: k_B",
    ...
    "epistemology": {
      ...
      "desc": "Volumen de microestados accesibles Ω en celdas cuánticas de volumen h³."
    }
  },
  {
    "id": 49,
    ...
    "epochName": "Termodinámica & Luz",
    "year": "1871",
    "author": "James Clerk Maxwell & Ludwig Boltzmann",
    "title": "Distribución de Maxwell-Boltzmann",
    "sub": "La Campana de Velocidades Moleculares",
    "cat": "MECÁNICA ESTADÍSTICA · 1871",
    "eq": "f(v) = 4π (m / 2π k_B T)^{3/2} · v² · e^{-m v² / 2 k_B T}",
    "eqShort": "f(v) ∝ v² e^{-m v² / 2k_B T}",
    "metric": "Velocidad Más Probable: v_p = √(2 k_B T / m)",
    ...
    "theta": 2.83,
    "phi": 0.64,
    "archetype": "maxwell_boltzmann_dist",
    "pal": 1,
    "modelKey": "maxwell_boltzmann",
    "epistemology": {
      "category": "B",
      "tag": "MECÁNICA ESTADÍSTICA · ESPACIO DE VELOCIDADES",
      "desc": "Densidad radial de probabilidad f(v) ∝ v² exp(-mv²/2k_BT) en el espacio tridimensional de velocidades."
    }
  },
  {
    "id": 50,
    ...
    "title": "Los Ceros Críticos de Riemann",
    "sub": "El Secreto Oculto de la Distribución de Primos",
    "cat": "PROBLEMA DEL MILENIO · 1859",
    "eq": "ζ(s) = ∑_{n=1}^{∞} n^{-s} = ∏_p (1 - p^{-s})⁻¹\nRe(s) = ½ (Ceros No Triviales)",
    "eqShort": "ζ(s) = 0 ⟹ Re(s) = ½",
    "metric": "Residuo Crítico: |Re(s_0) - 0.5| < 1e-15",
    ...
    "theta": 3.14,
    "phi": 0.52,
    "archetype": "riemann_zeta",
    "pal": 2,
    "modelKey": "riemann",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · RECTA CRÍTICA DE RIEMANN",
      "desc": "Función meromorfa analítica compleja; los ceros no triviales yacen en Re(s) = 1/2."
    }
  },
  {
    "id": 51,
    ...
    "year": "1854",
    "author": "Bernhard Riemann",
    "title": "Métrica Riemanniana y Curvatura Tensorial",
    "sub": "El Espacio No Euclidiano Curvado",
    "cat": "GEOMETRÍA DIFERENCIAL · 1854",
    "eq": "ds² = g_{μν} dx^μ dx^ν\nR^ρ_{σμν} = ∂_μ Γ^ρ_{νσ} - ∂_ν Γ^ρ_{μσ} + Γ^ρ_{μλ}Γ^λ_{νσ} - Γ^ρ_{νλ}Γ^λ_{μσ}",
    "eqShort": "ds² = g_{μν} dx^μ dx^ν",
    "metric": "Tensor de Curvatura de Riemann: R^ρ_{σμν}",
    ...
    "epistemology": {
      ...
      "desc": "Definición analítica de curvatura intrínseca independiente de inmersión en ℝ³."
    }
  },
  {
    "id": 52,
    ...
    "epochName": "Termodinámica & Luz",
    "year": "1879",
    "author": "Josef Stefan & Ludwig Boltzmann",
    "title": "Ley de Radiación de Stefan-Boltzmann",
    "sub": "La Potencia Emisiva del Cuerpo Negro",
    "cat": "RADIACIÓN TÉRMICA · 1879",
    "eq": "j* = σ · T⁴\nσ = 2π⁵ k_B⁴ / (15 c² h³) ≈ 5.670374 × 10⁻⁸ W/(m²·K⁴)",
    "eqShort": "j* = σ · T⁴",
    "metric": "Constante de Stefan-Boltzmann: σ",
    ...
    "theta": 3.77,
    "phi": 0.59,
    "archetype": "stefan_boltzmann",
    "pal": 0,
    "modelKey": "planck_quantum",
    "epistemology": {
      "category": "B",
      "tag": "RADIACIÓN TÉRMICA · FLUJO RADIATIVO",
      "desc": "Emisión total de energía proporcional a la cuarta potencia de la temperatura T⁴."
    }
  },
  {
    "id": 53,
    ...
    "sub": "El Color de la Temperatura Estelar",
    "cat": "FÍSICA TÉRMICA · 1893",
    "eq": "λ_{max} · T = b\nb ≈ 2.89777 × 10⁻³ m·K",
    "eqShort": "λ_max · T = b",
    "metric": "Constante de Wien: b ≈ 2.898e-3 m·K",
    ...
    "epistemology": {
      ...
      "desc": "Superficie espectral que muestra el corrimiento del pico hacia el ultravioleta."
    }
  },
  {
    "id": 54,
    ...
    "title": "Álgebra Dual y Diferenciación Automática",
    "sub": "El Infinitesimal Puro donde ε² = 0",
    "cat": "ÁLGEBRA DIFERENCIAL · 1873",
    "eq": "f(x + d · ε) = f(x) + d · f'(x) · ε   (ε² = 0)\na + b ε ∈ 𝔻",
    "eqShort": "f(x + ε) = f(x) + ε f'(x)",
    "metric": "Error de Truncamiento Numérico: 0.000000",
    ...
    "theta": 4.4,
    "phi": 0.54,
    "archetype": "clifford_dual",
    "pal": 2,
    "modelKey": "mobius",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · ÁLGEBRA DE NÚMEROS DUALES",
      "desc": "Estructura puramente algebraica con unidad nilpotente ε² = 0 para autodiferenciación exacta."
    }
  },
  {
    "id": 55,
    ...
    "year": "1899",
    "author": "Hendrik Lorentz",
    "title": "Las Transformaciones de Lorentz",
    "sub": "La Dilatación Temporal y Contracción Espacial",
    "cat": "RELATIVIDAD ESPECIAL · 1899",
    "eq": "t' = γ (t - v x / c²)\nx' = γ (x - v t)\nγ = 1 / √(1 - v²/c²)",
    "eqShort": "x' = γ(x - vt),  t' = γ(t - vx/c²)",
    "metric": "Factor de Lorentz: γ ≥ 1",
    ...
    "epistemology": {
      ...
      "desc": "Rotación hiperbólica del marco de referencia preserving el intervalo invariante."
    }
  },
  {
    "id": 56,
    ...
    "year": "1900",
    "author": "Henri Bénard",
    "title": "Celdas Convectivas de Bénard",
    "sub": "Autoorganización Térmica Hexagonal",
    "cat": "PATRONES DE CONVECCIÓN · 1900",
    "eq": "Ra = (g β ΔT d³) / (ν α) > Ra_c ≈ 1708\n∇·u = 0,  ∂T/∂t + u·∇T = α ∇²T",
    "eqShort": "Ra > Ra_c  (Hexágonos de Convección)",
    "metric": "Número de Rayleigh Crítico: Ra_c ≈ 1708",
    ...
    "theta": 5.03,
    "phi": 0.57,
    "archetype": "benard_convection",
    "pal": 0,
    "modelKey": "benard_convection",
    "epistemology": {
      "category": "A",
      "tag": "PATRONES DE CONVECCIÓN · CELDAS EN ℝ³",
      "desc": "Autoorganización hexagonal espontánea por inestabilidad de Rayleigh-Bénard."
    }
  },
  {
    "id": 57,
    ...
    "epochName": "Termodinámica & Luz",
    "year": "1936",
    "author": "Apolonio de Pérgamo / Frederick Soddy",
    "title": "Empaquetamiento Fractal de Apolonio",
    "sub": "Círculos Besadores y Curvatura Entera",
    "cat": "GEOMETRÍA FRACTAL · 1936",
    "eq": "2 (k₁² + k₂² + k₃² + k₄²) = (k₁ + k₂ + k₃ + k₄)²\nk_i = 1 / r_i",
    "eqShort": "2 ∑ k_i² = (∑ k_i)²",
    "metric": "Dimensión Fractal de Hausdorff: D ≈ 1.30568",
    ...
    "epistemology": {
      ...
      "desc": "Empaquetamiento fractal de círculos tangentes recíprocos de curvatura entera."
    }
  },
  {
    "id": 58,
    ...
    "title": "Teselación Espacial de Voronoi",
    "sub": "La Frontera de Proximidad y Equidad Geométrica",
    "cat": "GEOMETRÍA COMPUTACIONAL · 1908",
    "eq": "V(p_i) = { x ∈ ℝ² : ‖x - p_i‖ ≤ ‖x - p_j‖, ∀ j ≠ i }\nDel(P) = Dual(Vor(P))",
    "eqShort": "V(p_i) = { x : ‖x - p_i‖ ≤ ‖x - p_j‖ }",
    "metric": "Planaridad de Delaunay: Delaunay Triangulation Dual",
    ...
    "epistemology": {
      "category": "B",
      "tag": "GEOMETRÍA COMPUTACIONAL · TESELACIÓN DE PROXIMIDAD",
      "desc": "Fronteras poligonales de equidistancia respecto a semillas discretas."
    }
  },
  {
    "id": 59,
    ...
    "title": "Criterio de Fluencia de Von Mises",
    "sub": "El Límite Plástico de la Resistencia Material",
    "cat": "MECÁNICA DE MEDIOS CONTINUOS · 1913",
    "eq": "σ_v = √½ [(σ₁ - σ₂)² + (σ₂ - σ₃)² + (σ₃ - σ₁)²] ≤ σ_y\nJ₂ = ½ s_{ij} s_{ij} ≤ k²",
    "eqShort": "σ_v = √(3 J₂) ≤ σ_y",
    "metric": "Invariante Desviador: J₂ ≤ k²",
    ...
    "epistemology": {
      ...
      "desc": "Superficie de fluencia en el espacio de tensiones principales invariante ante presión hidrostática."
    }
  },
  {
    "id": 60,
    "badge": "061",
    "epoch": 4,
    "epochName": "Relatividad & Cuántica",
    "year": "1900",
    "author": "Max Planck",
    "title": "Cuantización de la Energía de Planck",
    "sub": "El Nacimiento del Fotón y la Era Cuántica",
    "cat": "MECÁNICA CUÁNTICA · 1900",
    "eq": "E = h · ν = ℏ · ω\nB_λ(T) = (2hc²/λ⁵) / (e^{hc/λk_B T} - 1)\nℏ ≈ 1.0545718 × 10⁻³⁴ J·s",
    "eqShort": "E = h · ν",
    "metric": "Constante de Planck: h = 6.62607015e-34 J·s",
    ...
    "epistemology": {
      ...
      "desc": "Modos propios electromagnéticos discretizados en paquetes hν."
    }
  },
  {
    "id": 61,
    ...
    "title": "El Efecto Fotoeléctrico de Einstein",
    "sub": "La Naturaleza Corpuscular de la Luz",
    "cat": "FÍSICA CUÁNTICA · 1905",
    "eq": "E_{k,max} = h · ν - Φ\ne V_0 = h ν - W",
    "eqShort": "E_k = h ν - Φ",
    "metric": "Frecuencia Umbral: ν_0 = Φ / h",
    ...
    "epistemology": {
      ...
      "desc": "Impacto balístico de fotones incidentes arrancando electrones del metal."
    }
  },
  {
    "id": 62,
    ...
    "year": "1905",
    "author": "Albert Einstein",
    "title": "Equivalencia Masa-Energía (E = mc²)",
    "sub": "La Identidad Suprema de la Materia",
    "cat": "RELATIVIDAD ESPECIAL · 1905",
    "eq": "E = m · c²\nE² = (p c)² + (m₀ c²)²",
    "eqShort": "E = m · c²",
    "metric": "Invariante Cuadrimomento: p_μ p^μ = -m₀² c²",
    ...
    "epistemology": {
      ...
      "desc": "E = mc²; identidad escalar universal de cuadrimomento relativista."
    }
  },
  {
    "id": 63,
    ...
    "title": "El Intervalo Espaciotemporal de Minkowski",
    "sub": "El Espacio-Tiempo Cuatridimensional Unificado",
    "cat": "GEOMETRÍA RELATIVISTA · 1908",
    "eq": "ds² = -c² dt² + dx² + dy² + dz²\nη_{μν} = diag(-1, 1, 1, 1)",
    "eqShort": "ds² = -c² dt² + dx² + dy² + dz²",
    "metric": "Invariante de Lorentz: ds²_A = ds²_B",
    ...
    "epistemology": {
      ...
      "desc": "Estructura causal cuatridimensional proyectada al espacio euclídeo."
    }
  },
  {
    "id": 64,
    ...
    "year": "1915",
    "author": "Albert Einstein",
    "title": "Ecuación de Campo de la Relatividad General",
    "sub": "La Curvatura Gravitatoria del Cosmos",
    "cat": "RELATIVIDAD GENERAL · 1915",
    "eq": "G_{μν} + Λ g_{μν} = (8πG / c⁴) · T_{μν}\nR_{μν} - ½ R g_{μν} = (8πG / c⁴) T_{μν}",
    "eqShort": "G_{μν} + Λ g_{μν} = (8πG / c⁴) T_{μν}",
    "metric": "Conservación de Energía-Momento: ∇_μ T^{μν} = 0",
    ...
    "epistemology": {
      ...
      "desc": "Tensor de Einstein acoplado a la densidad de energía-momento."
    }
  },
  {
    "id": 65,
    ...
    "title": "El Radio del Agujero Negro de Schwarzschild",
    "sub": "El Horizonte de Sucesos Ineludible",
    "cat": "ASTROFÍSICA RELATIVISTA · 1916",
    "eq": "r_s = 2 G M / c²\nds² = -(1 - r_s/r) c² dt² + (1 - r_s/r)⁻¹ dr² + r² dΩ²",
    "eqShort": "r_s = 2GM / c²",
    "metric": "Horizonte de Sucesos: g_00(r_s) = 0",
    ...
    "theta": 1.73,
    "phi": 0.91,
    "archetype": "schwarzschild_bh",
    "pal": 1,
    "modelKey": "schwarzschild",
    "epistemology": {
      "category": "A",
      "tag": "ASTROFÍSICA RELATIVISTA · AGUJERO NEGRO EN ℝ³",
      "desc": "Horizonte de sucesos esférico y curvatura espacial de Flamm."
    }
  },
  {
    "id": 66,
    ...
    "title": "Longitud de Onda Cuántica de De Broglie",
    "sub": "La Dualidad Onda-Corpúsculo de la Materia",
    "cat": "FÍSICA CUÁNTICA · 1924",
    "eq": "λ = h / p = h / (m · v)\np = ℏ · k",
    "eqShort": "λ = h / p",
    "metric": "Relación de Broglie: p = ℏ k",
    ...
    "theta": 2.04,
    "phi": 0.84,
    "archetype": "de_broglie_wave",
    "pal": 2,
    "modelKey": "de_broglie",
    "epistemology": {
      "category": "B",
      "tag": "FÍSICA CUÁNTICA · PAQUETE DE ONDA DE MATERIA",
      "desc": "Hélice compleja tridimensional de amplitud de probabilidad con longitud de onda λ = h/p."
    }
  },
  {
    "id": 67,
    ...
    "title": "La Ecuación de Onda Cuántica de Schrödinger",
    "sub": "La Evolución Temporal de la Amplitud de Probabilidad",
    "cat": "MECÁNICA CUÁNTICA · 1926",
    "eq": "i ℏ · ∂ψ/∂t = Ĥ ψ\nĤ = - (ℏ² / 2m) ∇² + V(r)",
    "eqShort": "i ℏ · ∂ψ/∂t = Ĥ ψ",
    "metric": "Unitaridad Cuántica: d/dt ⟨ψ|ψ⟩ = 0",
    ...
    "theta": 2.36,
    "phi": 0.95,
    "archetype": "schrodinger",
    "pal": 3,
    "modelKey": "quantum_orbital",
    "epistemology": {
      "category": "B",
      "tag": "MECÁNICA CUÁNTICA · ORBITAL ATÓMICO |Y_l^m|²",
      "desc": "Densidad espacial de probabilidad cuántica calculada analíticamente."
    }
  },
  {
    "id": 68,
    ...
    "sub": "El Límite Epistemológico del Conocimiento Físico",
    "cat": "FUNDAMENTOS CUÁNTICOS · 1927",
    "eq": "Δx · Δp ≥ ℏ / 2\n[x̂, p̂] = i ℏ · I\nΔE · Δt ≥ ℏ / 2",
    "eqShort": "Δx · Δp ≥ ℏ / 2",
    "metric": "Conmutador Canónico: [x, p] = iℏ",
    ...
    "theta": 2.67,
    "phi": 0.79,
    "archetype": "heisenberg_uncertainty",
    "pal": 0,
    "modelKey": "heisenberg",
    "epistemology": {
      "category": "B",
      "tag": "FUNDAMENTOS CUÁNTICOS · ELIPSOIDE SIMPLÉCTICO",
      "desc": "Volumen mínimo de acción de fase ΔxΔp ≥ ℏ/2 que preserva área bajo compresión."
    }
  },
  {
    "id": 69,
    ...
    "year": "1928",
    "author": "Paul Dirac",
    "title": "La Ecuación Relativista de Dirac",
    "sub": "La Predicción Teórica de la Antimateria",
    "cat": "TEORÍA CUÁNTICA DE CAMPOS · 1928",
    "eq": "(i γ^μ ∂_μ - m) ψ = 0\n{γ^μ, γ^ν} = 2 η^{μν} · I₄",
    "eqShort": "(i γ^μ ∂_μ - m) ψ = 0",
    "metric": "Álgebra de Clifford-Dirac: {γ^μ, γ^ν} = 2η^μν",
    ...
    "theta": 2.98,
    "phi": 0.89,
    "archetype": "dirac_equation",
    "pal": 1,
    "modelKey": "dirac",
    "epistemology": {
      "category": "B",
      "tag": "ELECTRODINÁMICA CUÁNTICA · DISPERSIÓN DE DIRAC",
      "desc": "Hiperboloide relativista con brecha de masa 2mc² y precesión de espinor de 4 componentes."
    }
  },
  {
    "id": 70,
    ...
    "year": "1931",
    "author": "Heinz Hopf",
    "title": "La Fibración Topológica de Hopf",
    "sub": "El Entrelazamiento Sagrado de la 3-Esfera",
    "cat": "TOPOLOGÍA ALGEBRAICA · 1931",
    "eq": "π: S³ → S²\n(z₀, z₁) ↦ z₀ / z₁\nFiber: S¹ (Great Circles)",
    "eqShort": "π: S³ → S²  (Fibras S¹)",
    "metric": "Invariante de Hopf: H(f) ∈ ℤ",
    ...
    "epistemology": {
      ...
      "desc": "Descomposición de la 3-esfera en círculos entrelazados de gran radio."
    }
  },
  {
    "id": 71,
    ...
    "epochName": "Relatividad & Cuántica",
    "year": "1929",
    "author": "Edwin Hubble & Georges Lemaître",
    "title": "La Ley de Expansión Cósmica de Hubble",
    "sub": "La Fuga de las Galaxias y el Nacimiento del Big Bang",
    "cat": "COSMOLOGÍA OBSERVACIONAL · 1929",
    "eq": "v = H₀ · d\nH₀ ≈ 70 (km/s) / Mpc",
    "eqShort": "v = H₀ · d",
    "metric": "Parámetro de Hubble: H(t) = ȧ / a",
    ...
    "theta": 3.61,
    "phi": 0.94,
    "archetype": "hubble_expansion",
    "pal": 3,
    "modelKey": "hubble_expansion",
    "epistemology": {
      "category": "A",
      "tag": "COSMOLOGÍA OBSERVACIONAL · EXPANSIÓN EN ℝ³",
      "desc": "Recesión métrica tridimensional de galaxias proporcional a la distancia v = H₀d."
    }
  },
  {
    "id": 72,
    ...
    "title": "Las Ecuaciones Cosmológicas de Friedmann",
    "sub": "La Dinámica Global del Espacio-Tiempo",
    "cat": "COSMOLOGÍA RELATIVISTA · 1922",
    "eq": "(ȧ/a)² = (8πG/3) ρ - (k c²/a²) + (Λ c²/3)\nä/a = - (4πG/3)(ρ + 3p/c²) + (Λ c²/3)",
    "eqShort": "(ȧ/a)² = (8πG/3)ρ - kc²/a²",
    "metric": "Métrica FLRW: ds² = -c²dt² + a(t)² dΣ_k²",
    ...
    "epistemology": {
      ...
      "desc": "Evolución dinámica del factor de escala del universo a(t)."
    }
  },
  {
    "id": 73,
    ...
    "year": "1918",
    "author": "Emmy Noether",
    "title": "El Teorema de Noether",
    "sub": "La Identidad Sagrada entre Simetría y Conservación",
    "cat": "FÍSICA TEÓRICA · 1918",
    "eq": "δS = 0 con simetría continua ⟹ ∂_μ J^μ = 0\nQ = ∫ J⁰ d³x = cte",
    "eqShort": "Simetría Continua ⟹ Carga Conservada",
    "metric": "Corriente de Noether Conservada: ∂_μ J^μ = 0",
    ...
    "epistemology": {
      ...
      "desc": "Dualidad matemática abstracta: a cada simetría continua de Lie le corresponde una carga conservada."
    }
  },
  {
    "id": 74,
    ...
    "sub": "El Andamiaje Cuántico de la Materia Sólida",
    "cat": "FÍSICA ATÓMICA · 1925",
    "eq": "ψ(x₁, x₂) = -ψ(x₂, x₁)\n|ψ(x, x)|² = 0\nΔn_fermion ∈ {0, 1}",
    "eqShort": "ψ(1, 2) = -ψ(2, 1)",
    "metric": "Antisimetría Fermiónica: P₁₂ ψ = -ψ",
    ...
    "epistemology": {
      ...
      "desc": "Bloqueo cuántico que impide la superposición de dos estados con idénticos números cuánticos."
    }
  },
  {
    "id": 75,
    ...
    "epochName": "Relatividad & Cuántica",
    "year": "1924",
    "author": "Satyendra Nath Bose & Albert Einstein",
    "title": "El Condensado de Bose-Einstein",
    "sub": "El Superátomo Gigante a Cero Absoluto",
    "cat": "FÍSICA CUÁNTICA MACROSCÓPICA · 1924",
    "eq": "N₀ / N = 1 - (T / T_c)^{3/2}\nT_c = (2πℏ²/m k_B) (n / ζ(3/2))^{2/3}",
    "eqShort": "N₀ = N (1 - (T/T_c)^{3/2})",
    "metric": "Longitud de Onda Térmica: λ_th > d_interatom",
    ...
    "epistemology": {
      ...
      "desc": "Colapso cooperativo de bosones en una única función de onda gigante al cero absoluto."
    }
  },
  {
    "id": 76,
    ...
    "epochName": "Relatividad & Cuántica",
    "year": "1974",
    "author": "Jacob Bekenstein & Stephen Hawking",
    "title": "Entropía de Agujeros Negros de Bekenstein-Hawking",
    "sub": "La Información Inscrita en el Horizonte de Sucesos",
    "cat": "GRAVEDAD CUÁNTICA · 1974",
    "eq": "S_{BH} = (k_B · c³ · A) / (4 G ℏ) = k_B · A / (4 ℓ_P²)\nℓ_P = √(ℏ G / c³)",
    "eqShort": "S_{BH} = k_B A / (4 ℓ_P²)",
    "metric": "Área de Planck: ℓ_P² ≈ 2.612e-70 m²",
    ...
    "epistemology": {
      ...
      "desc": "Capacidad informacional proporcional al área bidimensional del horizonte de sucesos."
    }
  },
  {
    "id": 77,
    ...
    "title": "La Radiación Térmica de Hawking",
    "sub": "La Evaporación Cuántica del Horizonte",
    "cat": "GRAVEDAD CUÁNTICA · 1974",
    "eq": "T_H = ℏ c³ / (8π G M k_B)\ndM/dt = - ℏ c⁴ / (15360 π G² M²)",
    "eqShort": "T_H = ℏ c³ / (8π G M k_B)",
    "metric": "Temperatura de Hawking: T_H ∝ 1/M",
    ...
    "epistemology": {
      ...
      "desc": "Pares partícula-antipartícula en el horizonte de sucesos relativista."
    }
  },
  {
    "id": 78,
    ...
    "title": "Teoría de Calibre No Abeliana de Yang-Mills",
    "sub": "El Andamiaje de las Fuerzas Nucleares",
    "cat": "PROBLEMA DEL MILENIO · 1954",
    "eq": "ℒ = - ¼ F^a_{μν} F^{a μν}\nF^a_{μν} = ∂_μ A^a_ν - ∂_ν A^a_μ + g f^{abc} A^b_μ A^c_ν\nΔm > 0 (Mass Gap)",
    "eqShort": "ℒ = - ¼ F^a_{μν} F^{a μν}",
    "metric": "Salto de Masa Cuántico: Δm > 0",
    ...
    "epistemology": {
      ...
      "desc": "Curvatura no lineal en el grupo de simetría SU(2) con gap energético fundamental."
    }
  },
  {
    "id": 79,
    ...
    "epochName": "Relatividad & Cuántica",
    "year": "1964",
    "author": "Peter Higgs & François Englert",
    "title": "El Mecanismo de Higgs y Masa Elemental",
    "sub": "La Ruptura Espontánea de Simetría Electrodébil",
    "cat": "FÍSICA DE PARTÍCULAS · 1964",
    "eq": "V(ϕ) = μ² (ϕ† ϕ) + λ (ϕ† ϕ)²   (μ² < 0)\nv = √(-μ² / λ) ≈ 246 GeV\nm_f = y_f · v / √2",
    "eqShort": "V(ϕ) = μ² |ϕ|² + λ |ϕ|⁴",
    "metric": "Valor de Expectación de Vacío: v ≈ 246 GeV",
    ...
    "theta": 6.13,
    "phi": 0.94,
    "archetype": "higgs_mechanism",
    "pal": 3,
    "modelKey": "higgs",
    "epistemology": {
      "category": "B",
      "tag": "FÍSICA DE PARTÍCULAS · SOMBRERO MEXICANO",
      "desc": "Ruptura espontánea de simetría en el potencial escalar que otorga masa inercial."
    }
  },
  {
    "id": 80,
    "badge": "081",
    "epoch": 5,
    "epochName": "Caos & Milenio",
    "year": "1931",
    "author": "Kurt Gödel",
    "title": "Teorema de Incompletitud de Gödel",
    "sub": "Los Límites Intrínsecos de la Verdad Formal",
    "cat": "LÓGICA MATEMÁTICA · 1931",
    "eq": "G ↔ ¬Prov(⌈G⌉)\nConsistente(T) ⟹ T ⊬ G  y  T ⊬ ¬G",
    "eqShort": "G ↔ ¬Prov(⌈G⌉)",
    "metric": "Incompletitud Aritmética: ∃ Proposiciones Indecidibles",
    ...
    "theta": 0,
    "phi": 1.05,
    "archetype": "godel_incompleteness",
    "pal": 0,
    "modelKey": "godel",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · LÓGICA AUTORREFERENCIAL",
      "desc": "Incompletitud formal pura; el enunciado no tiene cuerpo físico, es una verdad metamatemática indecidible."
    }
  },
  {
    "id": 81,
    ...
    "sub": "La Definición Matemática de Computación",
    "cat": "CIENCIAS DE LA COMPUTACIÓN · 1936",
    "eq": "M = ⟨Q, Σ, Γ, δ, q₀, B, F⟩\nδ: Q × Γ → Q × Γ × {L, R}\nHalting Problem: H(M, w) ∈ Indecidible",
    "eqShort": "δ: Q × Γ → Q × Γ × {L, R}",
    "metric": "Turing-Completitud: Universal Machine U",
    ...
    "theta": 0.31,
    "phi": 1.18,
    "archetype": "turing_machine",
    "pal": 1,
    "modelKey": "automata",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · MÁQUINA UNIVERSAL DE TURING",
      "desc": "Concepto abstracto de computabilidad algorítmica discreta."
    }
  },
  {
    "id": 82,
    ...
    "title": "La Entropía de la Información de Shannon",
    "sub": "La Cuantificación del Conocimiento y la Incertidumbre",
    "cat": "TEORÍA DE LA INFORMACIÓN · 1948",
    "eq": "H(X) = - ∑_{i=1}^{n} P(x_i) · log₂ P(x_i)\nI(X; Y) = H(X) - H(X|Y)",
    "eqShort": "H(X) = - ∑ P(x) log₂ P(x)",
    "metric": "Entropía de Shannon en Bits: H ≥ 0",
    ...
    "theta": 0.63,
    "phi": 1.1,
    "archetype": "shannon_entropy",
    "pal": 2,
    "modelKey": "shannon_entropy",
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · SÍMPLEX DE PROBABILIDAD",
      "desc": "Información pura H(X); concavidad de Shannon sobre el símplex de probabilidad 2D."
    }
  },
  {
    "id": 83,
    ...
    "epochName": "Caos & Milenio",
    "year": "1948",
    "author": "Claude Shannon & Ralph Hartley",
    "title": "Capacidad de Canal de Shannon-Hartley",
    "sub": "El Límite Físico de Transmisión de Datos",
    "cat": "TELECOMUNICACIONES · 1948",
    "eq": "C = B · log₂ (1 + S/N)\nEb/N0 ≥ ln 2 ≈ -1.59 dB",
    "eqShort": "C = B · log₂(1 + SNR)",
    "metric": "Límite de Shannon: C [bits/s]",
    ...
    "epistemology": {
      ...
      "desc": "Frontera superior de transmisión de bits en canales con ruido gaussiano."
    }
  },
  {
    "id": 84,
    ...
    "year": "1952",
    "author": "Alan Turing",
    "title": "El Telar de Morfogénesis de Turing",
    "sub": "La Creación de Patrones Biológicos Espontáneos",
    "cat": "BIOLOGÍA TEÓRICA · 1952",
    "eq": "∂u/∂t = D_u ∇²u + f(u, v)\n∂v/∂t = D_v ∇²v + g(u, v)\nD_v ≫ D_u  (Inestabilidad de Turing)",
    "eqShort": "∂u/∂t = D_u ∇²u - uv² + F(1-u)",
    "metric": "Longitud de Onda Crítica: λ_c ≈ 2π √(D_u/k)",
    ...
    "epistemology": {
      ...
      "desc": "Inestabilidad de reacción-difusión tejiendo patrones biológicos espaciales."
    }
  },
  {
    "id": 85,
    ...
    "epochName": "Caos & Milenio",
    "year": "1951",
    "author": "Boris Belousov & Anatoly Zhabotinsky",
    "title": "Reacción Química de Belousov-Zhabotinsky",
    "sub": "El Reloj Químico No Lineal Lejos del Equilibrio",
    "cat": "SISTEMAS DISIPATIVOS · 1951",
    "eq": "dx/dt = s(y - x y + x - q x²)\ndy/dt = s⁻¹(-y - x y + z)\ndz/dt = w(x - z)  (Ondas Espirales)",
    "eqShort": "Ondas Espirales BZ Químicas",
    "metric": "Período de Oscilación Límite: T_osc",
    ...
    "epistemology": {
      ...
      "desc": "Ondas espirales concéntricas en un medio no lineal lejos del equilibrio."
    }
  },
  {
    "id": 86,
    ...
    "title": "El Atractor Caótico de Lorenz",
    "sub": "El Efecto Mariposa y el Caos Determinista",
    "cat": "TEORÍA DEL CAOS · 1963",
    "eq": "dx/dt = σ(y - x)\ndy/dt = x(ρ - z) - y\ndz/dt = x y - β z\nσ = 10, ρ = 28, β = 8/3",
    "eqShort": "dx/dt=10(y-x), dy/dt=x(28-z)-y",
    "metric": "Exponente Máximo de Lyapunov: λ₁ ≈ +0.9056",
    ...
    "theta": 1.88,
    "phi": 1.06,
    "archetype": "lorenz_attractor",
    "pal": 2,
    "modelKey": "lorenz",
    "epistemology": {
      "category": "B",
      "tag": "TEORÍA DEL CAOS · ATRACTOR DE LORENZ",
      "desc": "Órbita continua aperiódica en el espacio de fases tridimensional."
    }
  },
  {
    "id": 87,
    ...
    "year": "1976",
    "author": "Otto Rössler",
    "title": "La Cinta Plegada de Rössler",
    "sub": "La Herradura de Smale en Dinámica Continua",
    "cat": "TOPOLOGÍA CAÓTICA · 1976",
    "eq": "dx/dt = -y - z\ndy/dt = x + a y\ndz/dt = b + z(x - c)\na = 0.2, b = 0.2, c = 5.7",
    "eqShort": "dx/dt = -y-z, dy/dt = x+ay",
    "metric": "Dimensión Fractal de Correlación: D ≈ 2.01",
    ...
    "theta": 2.2,
    "phi": 1.27,
    "archetype": "rossler_attractor",
    "pal": 3,
    "modelKey": "rossler",
    "epistemology": {
      "category": "B",
      "tag": "TOPOLOGÍA CAÓTICA · CINTA PLEGADA DE RÖSSLER",
      "desc": "Herradura de Smale en dinámica continua con un solo plegamiento periódico."
    }
  },
  {
    "id": 88,
    ...
    "epochName": "Caos & Milenio",
    "year": "1976",
    "author": "Robert May & Mitchell Feigenbaum",
    "title": "El Mapa Logístico y Universalidad de Feigenbaum",
    "sub": "La Cascada de Duplicación de Período al Caos",
    "cat": "DINÁMICA NO LINEAL · 1976",
    "eq": "x_{n+1} = r · x_n (1 - x_n)\nlim (r_n - r_{n-1}) / (r_{n+1} - r_n) = δ ≈ 4.6692016\nα ≈ 2.5029078",
    "eqShort": "x_{n+1} = r x_n (1 - x_n)",
    "metric": "Constante Universal de Feigenbaum: δ ≈ 4.66920",
    ...
    "theta": 2.51,
    "phi": 1.15,
    "archetype": "logistic_feigenbaum",
    "pal": 0,
    "modelKey": "feigenbaum",
    "epistemology": {
      "category": "B",
      "tag": "DINÁMICA NO LINEAL · ÁRBOL 3D DE BIFURCACIÓN",
      "desc": "Cascada de duplicación de período calculada analíticamente con constante universal δ."
    }
  },
  {
    "id": 89,
    ...
    "epochName": "Caos & Milenio",
    "year": "1980",
    "author": "Benoît Mandelbrot & Gaston Julia",
    "title": "El Conjunto Fractal de Mandelbrot",
    "sub": "La Huella Digital Infinita de la Geometría Compleja",
    "cat": "FRACTALES COMPLEJOS · 1980",
    "eq": "z_{n+1} = z_n² + c\nM = { c ∈ ℂ : lim_{n→∞} |z_n| ≤ 2 }\nDim_H(∂M) = 2",
    "eqShort": "z_{n+1} = z_n² + c",
    "metric": "Frontera Conexa de Mandelbrot: Shishikura Dim = 2",
    ...
    "epistemology": {
      ...
      "desc": "Frontera de escape iterativo en el álgebra de cuaterniones."
    }
  },
  {
    "id": 90,
    ...
    "title": "Sincronización de Fase de Kuramoto",
    "sub": "El Orden Colectivo Emergente de Osciladores",
    "cat": "SISTEMAS COMPLEJOS · 1975",
    "eq": "dθ_i / dt = ω_i + (K / N) ∑_{j=1}^{N} sin(θ_j - θ_i)\nr e^{iψ} = (1/N) ∑ e^{iθ_j}",
    "eqShort": "dθ_i/dt = ω_i + (K/N) ∑ sin(θ_j - θ_i)",
    "metric": "Parámetro de Orden de Kuramoto: 0 ≤ r ≤ 1",
    ...
    "theta": 3.14,
    "phi": 1.04,
    "archetype": "kuramoto_sync",
    "pal": 2,
    "modelKey": "kuramoto",
    "epistemology": {
      "category": "B",
      "tag": "SISTEMAS COMPLEJOS · ESPACIO DE FASES SINC",
      "desc": "Sincronización espontánea en el círculo S¹ y emergencia del parámetro de orden macróscopico."
    }
  },
  {
    "id": 91,
    ...
    "title": "La Ecuación Estocástica de Langevin",
    "sub": "El Movimiento Browniano con Fuerza Fluctuante",
    "cat": "FÍSICA ESTOCÁSTICA · 1908",
    "eq": "m · dv/dt = -γ · v + ξ(t)\n⟨ξ(t)⟩ = 0,  ⟨ξ(t) ξ(t')⟩ = 2 k_B T γ · δ(t - t')",
    "eqShort": "m dv/dt = -γ v + ξ(t)",
    "metric": "Teorema de Fluctuación-Disipación: D = k_B T / γ",
    ...
    "theta": 3.45,
    "phi": 1.28,
    "archetype": "langevin_stochastic",
    "pal": 3,
    "modelKey": "langevin",
    "epistemology": {
      "category": "B",
      "tag": "FÍSICA ESTOCÁSTICA · DIFUSIÓN DE EINSTEIN",
      "desc": "Paseo browniano tridimensional acoplado a la esfera difusiva ⟨r²⟩ = 6Dt."
    }
  },
  {
    "id": 92,
    ...
    "title": "Ecuación de Opciones de Black-Scholes",
    "sub": "La Geometría de la Cobertura Financiera",
    "cat": "MATEMÁTICA FINANCIERA · 1973",
    "eq": "∂V/∂t + ½ σ² S² (∂²V/∂S²) + r S (∂V/∂S) - r V = 0\ndS = μ S dt + σ S dW_t",
    "eqShort": "∂V/∂t + ½ σ² S² ∂²V/∂S² + rS ∂V/∂S - rV = 0",
    "metric": "Arbitrage-Free Pricing: dΠ = r Π dt",
    ...
    "theta": 3.77,
    "phi": 1.14,
    "archetype": "black_scholes",
    "pal": 0,
    "modelKey": "black_scholes",
    "epistemology": {
      "category": "B",
      "tag": "MATEMÁTICA FINANCIERA · SUPERFICIE DE VOLATILIDAD",
      "desc": "Ecuación parabólica de difusión y curvatura de cobertura dinámica."
    }
  },
  {
    "id": 93,
    ...
    "epochName": "Caos & Milenio",
    "year": "1983",
    "author": "Stephen Wolfram & Matthew Cook",
    "title": "Autómata Celular Regla 110 (Turing Completo)",
    "sub": "La Complejidad Suprema a Partir de Reglas Mínimas",
    "cat": "COMPUTACIÓN UNIVERSAL · 1983 / 2004",
    "eq": "s_i^{t+1} = (s_{i-1}^t ⊕ s_i^t ⊕ s_{i+1}^t ...) = Rule 110\n01101110_2 = 110",
    "eqShort": "Rule 110: Local CA → Universal Computation",
    "metric": "Clase 4 de Wolfram: Complejidad en el Borde del Caos",
    ...
    "epistemology": {
      ...
      "desc": "Regla booleana elemental unidimensional que genera computación universal."
    }
  },
  {
    "id": 94,
    ...
    "sub": "El Orden Emergente tras el Caos Aparente",
    "cat": "VIDA ARTIFICIAL · 1986",
    "eq": "Blanca ⟹ Giro 90° D, Invierte, Avanza 1\nNegra  ⟹ Giro 90° I, Invierte, Avanza 1\nt > 10,000 ⟹ Highway (Period 104)",
    "eqShort": "Langton Ant: 104-step Emergent Highway",
    "metric": "Período Asintótico de Autopista: T = 104 pasos",
    ...
    "epistemology": {
      ...
      "desc": "Comportamiento emergente asintótico sobre una grilla discreta de dos dimensiones."
    }
  },
  {
    "id": 95,
    ...
    "title": "El Integrador Simpléctico de 4º Orden de Yoshida",
    "sub": "La Conservación Numérica Exacta de la Energía",
    "cat": "MECÁNICA CELESTE COMPUTACIONAL · 1990",
    "eq": "z_{n+1} = exp(c_i Δt D_A) exp(d_i Δt D_B) z_n\nw₁ = 1 / (2 - 2^{1/3}),  w₀ = -2^{1/3} w₁",
    "eqShort": "z_{n+1} = ∏ exp(c_i Δt D_A) exp(d_i Δt D_B) z_n",
    "metric": "Deriva Energética Secular: ΔH ≤ 1e-15 J",
    ...
    "epistemology": {
      ...
      "desc": "Conservación numérica exacta de energía mediante coeficientes simplécticos de 4º orden."
    }
  },
  {
    "id": 96,
    ...
    "year": "1993",
    "author": "Andrew Beal",
    "title": "El Desierto de la Conjetura de Beal",
    "sub": "La Repulsión de las Potencias Coprimas",
    "cat": "TEORÍA DE NÚMEROS · 1993",
    "eq": "A^x + B^y = C^z  (x, y, z > 2) ⟹ gcd(A, B, C) > 1\nPremio Beal: $1,000,000 USD",
    "eqShort": "A^x + B^y = C^z (x,y,z>2) ⟹ gcd > 1",
    "metric": "Exclusión Coprima: 100% Sin Soluciones para gcd=1",
    ...
    "epistemology": {
      ...
      "desc": "Conjetura diofántica de exponentes enteros Aˣ + Bʸ = Cᶻ."
    }
  },
  {
    "id": 97,
    ...
    "title": "El Flujo de Ricci de Perelman (Poincaré)",
    "sub": "El Alisamiento Métrico a la 3-Esfera",
    "cat": "PROBLEMA DEL MILENIO RESUELTO · 2002",
    "eq": "∂g_{ij} / ∂t = -2 R_{ij}\nℱ = ∫ (R + |∇f|²) e^{-f} dV\nConjetura de Poincaré: M³ cerrada y simplemente conexa ≅ S³",
    "eqShort": "∂g_{ij}/∂t = -2 R_{ij}  ⟹ M³ ≅ S³",
    "metric": "Curvatura Escalar Monótona: dℱ/dt ≥ 0",
    ...
    "theta": 5.34,
    "phi": 1.25,
    "archetype": "ricci_flow",
    "pal": 1,
    "modelKey": "ricci_flow",
    "epistemology": {
      "category": "B",
      "tag": "GEOMETRÍA DIFERENCIAL · FLUJO DE RICCI DE PERELMAN",
      "desc": "Difusión de curvatura alisando una variedad tridimensional hasta la esfera S³."
    }
  },
  {
    "id": 98,
    ...
    "year": "1971",
    "author": "Stephen Cook",
    "title": "P versus NP y Complejidad Computacional",
    "sub": "La Gran Pregunta del Pensamiento Humano",
    "cat": "PROBLEMA DEL MILENIO · 1971",
    "eq": "P ≟ NP\nSAT ∈ NP-Completo (Cook-Levin Theorem)\n¿Verificar en tiempo polinómico implica resolver en tiempo polinómico?",
    "eqShort": "P ≟ NP  (¿Es Verificar = Resolver?)",
    "metric": "Complejidad Asintótica: P ⊆ NP ⊆ PSPACE",
    ...
    "epistemology": {
      "category": "C",
      "tag": "PROYECCIÓN CANÓNICA · COMPLEJIDAD COMPUTACIONAL",
      "desc": "Pregunta fundamental de la teoría de complejidad formal; hipercubo de satisfacibilidad."
    }
  },
  {
    "id": 99,
    ...
    "epochName": "Caos & Milenio",
    "year": "1970s",
    "author": "Glashow, Weinberg, Salam & Veltman",
    "title": "El Lagrangiano del Modelo Estándar",
    "sub": "La Ecuación que Describe Todo lo que Tocamos",
    "cat": "FÍSICA FUNDAMENTAL · 1970s",
    "eq": "ℒ_{SM} = - ¼ F_{μν} F^{μν} + i ψ̄ ⧸D ψ + |D_μ ϕ|² - V(ϕ) + ψ̄_i Y_{ij} ψ_j ϕ + h.c.\nSU(3)_C × SU(2)_L × U(1)_Y",
    "eqShort": "ℒ_{SM} = -¼ F² + iψ̄⧸Dψ + |Dϕ|² - V(ϕ) + Yψ̄ψϕ",
    "metric": "Grupo de Calibre: SU(3) × SU(2) × U(1)",
    ...
    "epistemology": {
      ...
      "desc": "Interacción geométrica de los grupos de simetría SU(3)×SU(2)×U(1)."
    }
  }
];
